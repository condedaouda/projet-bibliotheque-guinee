...
if (isset($_POST['classe']) and isset($_POST['matiere'])) {
    ...
    $_SESSION['classe_livre'] = $_POST['classe'];
    $_SESSION['matiere_livre'] = $_POST['matiere'];
    
    
//echo '<button type="button" class="btn btn-success btn_ecole_ajout"><a href="./AjouterModifSupprimer/AjoutLivre.php">Ajouter</a></button><br><br>';
// recuperation des donnees

?>
<div class="a_btn_ajout">
    <a href="./AjouterModifSupprimer/AjoutLivre.php">Ajouter</a>
</div>

<table class="table">

<?php
$resultat = $connexion->query("SELECT * FROM livres WHERE class = '$classe' AND matiere = '$matiere'");
...
?>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form method="POST" action="./AjouterModifSupprimer/editerLivre.php">
            ...
            <td>
                <form method="POST" action="./AjouterModifSupprimer/supprimerLivre.php">
            ...
            <td>
                <img src="../../livres/<?php echo $classe; ?>/<?php echo $matiere; ?>/<?php echo $donnees['image']; ?>" class='img-thumbnail photo_livre'>
            </td>
