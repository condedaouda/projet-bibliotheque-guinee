...
<?php
$classee = $_SESSION['classe_brochure'];
$matieree = $_SESSION['matiere_brochure'];

    if (isset($_POST['editer'])) {
        $_SESSION['brochure_edit_id'] = $_POST['editer'];
    }
    $id =  $_SESSION['brochure_edit_id'];
    ...
    if (isset($_POST['commentaire']) and !empty($_FILES['image']['name'])) {
        ...
        $modification = $connexion->prepare("UPDATE brochures 
		SET nom = :nom,
			image = :image,
		...
		WHERE id = :id");
            ...
            echo '<div class="after_edit_doc">';
                ...
                echo '<button type="button" class="btn btn-success"><a href="../Brochure.php">Retour</a></button><br><br>';
            echo '</div>';
...
<div class="before_edit_doc">
    <form method="post" action="editerBrochure.php" enctype="multipart/form-data" >
        <label for="commentaire">Commentaire</label><br>
        <textarea name="commentaire" rows="3" cols="35" required><?php echo  $donnees['commentaire']?></textarea><br>
        ...
        <img src="../../../brochures/<?php echo $classee; ?>/<?php echo $matieree; ?>/<?php echo $donnees['image']; ?>" class='img-thumbnail photo_livre' style="width:200px"><br>
