...
<body>
    ...
    if (isset($_POST['commentaire']) and !empty($_FILES['image']['name'])) {
        ...
        $class = $_SESSION['classe_livre'];
        $matiere = $_SESSION['matiere_livre'];
        ...
        if ($resultaImage AND $resultaLivre) {
            ...
            "INSERT INTO livres(nom, class, matiere, image, commentaire)
            ...
            echo '<div class="btn_apres_ajout">';
                echo '<h4>Livre ajouté</h4>';
                echo '<button type="button" class="btn btn-success"><a href="../livre.php">Retour</a></button>';
            echo '</div>';
...
<div class="form_ajout_livre">
    <form method="post" action="ajoutLivre.php" enctype="multipart/form-data" >
